...
<?php 
    ...
    $account_type = filter_input(INPUT_POST, 'type');
    ...
    foreach ($required_fields as $required_field) 
    {
        ...
        {
            if ($required_field === "password" || $required_field === "confirm_password") 
            {
                continue;
    ...
    $password = password_hash($password, PASSWORD_DEFAULT); // B-Crypt 

    // unset username and password confirmation 
    ...
    if (sizeof($errors) === 0) 
    {
        try 
        {
            ...
            if ($account_type == 'r')
            {
                //sql stmt to post the data 
                $sql = "INSERT INTO rentee (username,password,first_name, last_name,age,gender,email, phone) VALUES (:username, :password,:first_name, :last_name, :age, :gender, :email, :phone);";
                ...
                $_SESSION['successes'] = "You have been successfully registered with Carex";
            ...
            if ($account_type == 'l')
            {
                ...
                //sql stmt to post the data 
                $sql = "INSERT INTO renter (username, password,first_name, last_name,age,gender,email, phone) 
                VALUES (:username,:password,:first_name, :last_name, :age, :gender, :email, :phone);";
