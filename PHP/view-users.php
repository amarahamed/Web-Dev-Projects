        ...
        <?php 
            try 
            {
                ...
                foreach ($records as $record) 
                {
                    ...
                    <td>".$record['email']."</td>
                    <td>".$record['phone']."</td>
                    <td><a class='btn btn-primary btn-sm' href='user_reg.php?user_id=".$record['id']."&type=".$type."'>Edit</a></td>
                    <td><a class='btn btn-danger btn-sm' href='delete_user.php?user_id=".$record['id']."'>Delete</a></td>
                    </tr>";
                }                
                echo "</tbody></table>";
